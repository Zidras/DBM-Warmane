...
color1Type1:SetColorRGB(DBM.Bars.options.StartColorAR, DBM.Bars.options.StartColorAG, DBM.Bars.options.StartColorAB)
color1Type1text:SetTextColor(DBM.Bars.options.StartColorAR, DBM.Bars.options.StartColorAG, DBM.Bars.options.StartColorAB)
color2Type1:SetColorRGB(DBM.Bars.options.EndColorAR, DBM.Bars.options.EndColorAG, DBM.Bars.options.EndColorAB)
color2Type1text:SetTextColor(DBM.Bars.options.EndColorAR, DBM.Bars.options.EndColorAG, DBM.Bars.options.EndColorAB)
...
color1Type2:SetColorRGB(DBM.Bars.options.StartColorAER, DBM.Bars.options.StartColorAEG, DBM.Bars.options.StartColorAEB)
color1Type2text:SetTextColor(DBM.Bars.options.StartColorAER, DBM.Bars.options.StartColorAEG, DBM.Bars.options.StartColorAEB)
color2Type2:SetColorRGB(DBM.Bars.options.EndColorAER, DBM.Bars.options.EndColorAEG, DBM.Bars.options.EndColorAEB)
color2Type2text:SetTextColor(DBM.Bars.options.EndColorAER, DBM.Bars.options.EndColorAEG, DBM.Bars.options.EndColorAEB)
...
color1Type3:SetColorRGB(DBM.Bars.options.StartColorDR, DBM.Bars.options.StartColorDG, DBM.Bars.options.StartColorDB)
color1Type3text:SetTextColor(DBM.Bars.options.StartColorDR, DBM.Bars.options.StartColorDG, DBM.Bars.options.StartColorDB)
color2Type3:SetColorRGB(DBM.Bars.options.EndColorDR, DBM.Bars.options.EndColorDG, DBM.Bars.options.EndColorDB)
color2Type3text:SetTextColor(DBM.Bars.options.EndColorDR, DBM.Bars.options.EndColorDG, DBM.Bars.options.EndColorDB)
...
color1Type4:SetColorRGB(DBM.Bars.options.StartColorIR, DBM.Bars.options.StartColorIG, DBM.Bars.options.StartColorIB)
color1Type4text:SetTextColor(DBM.Bars.options.StartColorIR, DBM.Bars.options.StartColorIG, DBM.Bars.options.StartColorIB)
color2Type4:SetColorRGB(DBM.Bars.options.EndColorIR, DBM.Bars.options.EndColorIG, DBM.Bars.options.EndColorIB)
color2Type4text:SetTextColor(DBM.Bars.options.EndColorIR, DBM.Bars.options.EndColorIG, DBM.Bars.options.EndColorIB)
...
color1Type5:SetColorRGB(DBM.Bars.options.StartColorRR, DBM.Bars.options.StartColorRG, DBM.Bars.options.StartColorRB)
color1Type5text:SetTextColor(DBM.Bars.options.StartColorRR, DBM.Bars.options.StartColorRG, DBM.Bars.options.StartColorRB)
color2Type5:SetColorRGB(DBM.Bars.options.EndColorRR, DBM.Bars.options.EndColorRG, DBM.Bars.options.EndColorRB)
color2Type5text:SetTextColor(DBM.Bars.options.EndColorRR, DBM.Bars.options.EndColorRG, DBM.Bars.options.EndColorRB)
...
color1Type6:SetColorRGB(DBM.Bars.options.StartColorPR, DBM.Bars.options.StartColorPG, DBM.Bars.options.StartColorPB)
color1Type6text:SetTextColor(DBM.Bars.options.StartColorPR, DBM.Bars.options.StartColorPG, DBM.Bars.options.StartColorPB)
color2Type6:SetColorRGB(DBM.Bars.options.EndColorPR, DBM.Bars.options.EndColorPG, DBM.Bars.options.EndColorPB)
color2Type6text:SetTextColor(DBM.Bars.options.EndColorPR, DBM.Bars.options.EndColorPG, DBM.Bars.options.EndColorPB)
...
color1Type7:SetColorRGB(DBM.Bars.options.StartColorUIR, DBM.Bars.options.StartColorUIG, DBM.Bars.options.StartColorUIB)
color1Type7text:SetTextColor(DBM.Bars.options.StartColorUIR, DBM.Bars.options.StartColorUIG, DBM.Bars.options.StartColorUIB)
color2Type7:SetColorRGB(DBM.Bars.options.EndColorUIR, DBM.Bars.options.EndColorUIG, DBM.Bars.options.EndColorUIB)
color2Type7text:SetTextColor(DBM.Bars.options.EndColorUIR, DBM.Bars.options.EndColorUIG, DBM.Bars.options.EndColorUIB)
...
forceLarge:SetScript("OnClick", function(self)
	DBM.Bars:SetOption("Bar7ForceLarge", not DBM.Bars.options.Bar7ForceLarge)
	if DBM.Bars.options.Bar7ForceLarge then
...
customInline:SetScript("OnClick", function(self)
	DBM.Bars:SetOption("Bar7CustomInline", not DBM.Bars.options.Bar7CustomInline)
