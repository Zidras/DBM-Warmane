...
L.NEED_SUPPORT						= "Are you good with programming or languages? If yes, the DBM team needs your help to keep DBM the best boss mod for WoW. Join the team by visiting www.deadlybossmods.com or sending a message to tandanu@deadlybossmods.com or nitram@deadlybossmods.com."

L.LOAD_MOD_ERROR					= "Error while loading boss mods for %s: %s"
L.LOAD_MOD_SUCCESS					= "Loaded '%s' boss mods. For more options, type /dbm in your chat."
...
L.PROFILE_NOT_FOUND					= "<Deadly Boss Mods> Your current profile is corrupted. Deadly Boss Mods will load 'Default' profile."
...
L.OPTION_CATEGORY_WARNINGS			= "Announces"
L.OPTION_CATEGORY_MISC				= "Miscellaneous"
...
L.VERSIONCHECK_FOOTER				= "Found %d player(s) with DBM"
L.VERSIONCHECK_OUTDATED				= "Following %d player(s) have outdated boss mod version: %s"
L.YOUR_VERSION_OUTDATED				= "Your version of Deadly Boss Mods is out-of-date. Please visit " .. L.UPDATEREMINDER_URL .. " to get the latest version."
...
L.UPDATEREMINDER_HEADER				= "Your version of Deadly Boss Mods is out-of-date.\n Version %s (r%d) is available for download here:"
...
L.UPDATEREMINDER_NOTAGAIN			= "Show popup when a new version is available"
...
L.RANGERADAR_IN_RANGE_TEXT			= "%d in range (%dyd)"--Multi
L.RANGERADAR_IN_RANGE_TEXTONE		= "%s (%0.1fyd)"--One target
...
L.BAD_LOAD							= "DBM has detected your mod for this instance failed to fully load correctly because of combat. As soon as you are out of combat, please do /console reloadui as soon as possible."
...
L.ANNOUNCE_BREAK_OVER				= "Break time is over"
L.TIMER_PULL						= "Pull in"
L.ANNOUNCE_PULL						= "Pull in %d sec"
...
L.AUTO_ARROW_OPTION_TEXT			= "Show Deadly Boss Mods Arrow to move toward target affected by $spell:%s"
L.AUTO_ARROW_OPTION_TEXT2			= "Show Deadly Boss Mods Arrow to move away from target affected by $spell:%s"
L.AUTO_ARROW_OPTION_TEXT3			= "Show Deadly Boss Mods Arrow to move toward specific location for $spell:%s"
...
L.AUTO_ICONS_OPTION_TEXT			= "Set icons on $spell:%d targets"
...
L.MOVE_WARNING_MESSAGE				= "Thanks for using Deadly Boss Mods"
...
--LDB
L.LDB_TOOLTIP_HELP1					= "Click to open DBM"
