...
-------------------------------
DBM = {
	Revision = ("$Revision: 6008 $"):sub(12, -3),
	Version = "6.08",
	DisplayVersion = "6.08 DBM-WoWCircle by Barsoom for WoWCircle WotLK (https://github.com/ArsumPB/DBM-wowcircle)", -- the string that is shown as version
	ReleaseRevision = 6008 -- the revision of the latest stable version that is available (for /dbm ver2)
}
