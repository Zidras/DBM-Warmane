...
DBM = {
	Revision = parseCurseDate("20250624101610"),
	DisplayVersion = "10.1.13 - WoE Edition", -- the string that is shown as version
	ReleaseRevision = releaseDate(2025, 06, 24) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
