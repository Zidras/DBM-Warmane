...
-------------------------------
DBM = {
	Revision = ("$Revision: 6003 $"):sub(12, -3),
	Version = "6.03",
	DisplayVersion = "6.03 DBM-WoWCircle by Barsoom for WoWCircle WotLK (https://github.com/ArsumPB/DBM-wowcircle)", -- the string that is shown as version
	ReleaseRevision = 6003 -- the revision of the latest stable version that is available (for /dbm ver2)
}
