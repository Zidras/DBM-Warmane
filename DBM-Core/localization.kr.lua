...
L.AUTO_TIMER_OPTIONS.cast		= "$spell:%s 시전 타이머 바 보기 (%ds)"
L.AUTO_TIMER_OPTIONS.castcount		= "$spell:%s 시전 타이머 바 보기 (횟수 포함) (%ds)"
L.AUTO_TIMER_OPTIONS.castsource		= "$spell:%s 시전 타이머 바 보기 (시전자 이름 포함) (%ds)"
L.AUTO_TIMER_OPTIONS.active		= "$spell:%s 지속 시간 타이머 바 보기 (%ds)"
L.AUTO_TIMER_OPTIONS.fades		= "$spell:%s 남은 시간 타이머 바 보기 (%ds)"
L.AUTO_TIMER_OPTIONS.ai				= "$spell:%s 쿨타임의 인공지능 예상 타이머 바 보기 (%ds)"
L.AUTO_TIMER_OPTIONS.cd				= "$spell:%s 쿨타임 타이머 바 보기 (%ds)"
L.AUTO_TIMER_OPTIONS.cdcount		= "$spell:%s 쿨타임 타이머 바 보기 (%ds)"
L.AUTO_TIMER_OPTIONS.cdnp				= "$spell:%s 쿨타임 타이머를 이름표에만 표시 (%ds)"
L.AUTO_TIMER_OPTIONS.cdnpcount			= "$spell:%s 쿨타임 타이머를 이름표에만 표시 (횟수 포함) (%ds)"
L.AUTO_TIMER_OPTIONS.cdsource		= "$spell:%s 쿨타임 타이머 바 보기 (시전자 이름 포함) (%ds)"
L.AUTO_TIMER_OPTIONS.cdspecial		= "특수 능력 쿨타임 타이머 바 보기 (%ds)"
L.AUTO_TIMER_OPTIONS.next		= "다음 $spell:%s 타이머 바 보기 (%ds)"
L.AUTO_TIMER_OPTIONS.nextcount		= "다음 $spell:%s 타이머 바 보기 (%ds)"
L.AUTO_TIMER_OPTIONS.nextnp				= "다음 $spell:%s 타이머를 이름표에만 표시 (%ds)"
