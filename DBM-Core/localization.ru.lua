...
L.AUTO_TIMER_OPTIONS.targetcount 	= "Отсчёт времени действия дебаффа (со счётчиком) $spell:%s (%ds)"
...
L.AUTO_ICONS_OPTION_CONFLICT		= " (Может противоречить другим вариантам)"
