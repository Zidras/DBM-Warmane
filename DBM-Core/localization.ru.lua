...
DBM_CORE_RANGECHECK_OPTION_RADAR	= "Показать фрейм радара"
DBM_CORE_RANGECHECK_OPTION_TEXT		= "Показать старый текстовый фрейм"
DBM_CORE_RANGECHECK_OPTION_BOTH		= "Показать оба"
...
DBM_CORE_RANGERADAR_HEADER			= "Радар дистанции (%d м)"
