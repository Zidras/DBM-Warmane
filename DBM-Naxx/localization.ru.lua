...
L:SetOptionLocalization({
	...
	EqUneqWeaponsKT	= "Автоматически снимать и надевать оружия перед и после контроля. Для работы этой функции создайте два набора экипировки 'pve' для одетых пушек и 'nw' для снятых.",
