...
local specWarnSuppressorOne			= mod:NewSpecialWarning("Suppressors")
local specWarnSuppressorTwo			= mod:NewSpecialWarning("Suppressors")
local specWarnSuppressorThree		= mod:NewSpecialWarning("Suppressors")
local specWarnSuppressorFour		= mod:NewSpecialWarning("Suppressors")
...
local timerSuppressorOne			= mod:NewTimer(30, "TimerSuppressorOne","Interface\\AddOns\\DBM-Core\\textures\\CryptFiendUnBurrow.blp")
local timerSuppressorTwo			= mod:NewTimer(58, "TimerSuppressorTwo","Interface\\AddOns\\DBM-Core\\textures\\CryptFiendUnBurrow.blp")
local timerSuppressorThree			= mod:NewTimer(62, "TimerSuppressorThree","Interface\\AddOns\\DBM-Core\\textures\\CryptFiendUnBurrow.blp")
local timerSuppressorFour			= mod:NewTimer(50, "TimerSuppressorFour","Interface\\AddOns\\DBM-Core\\textures\\CryptFiendUnBurrow.blp")

local soundSpecWarnSuppressor	= mod:NewSound(70935)
...
function mod:OnCombatStart(delay)
	...
	soundSpecWarnSuppressor:Schedule(30, "Interface\\AddOns\\DBM-Core\\sounds\\RaidAbilities\\SuppressorsSpawned.mp3")
	specWarnSuppressorTwo:Schedule(88)
	soundSpecWarnSuppressor:Schedule(88, "Interface\\AddOns\\DBM-Core\\sounds\\RaidAbilities\\SuppressorsSpawned.mp3")
	specWarnSuppressorThree:Schedule(150)
	soundSpecWarnSuppressor:Schedule(150, "Interface\\AddOns\\DBM-Core\\sounds\\RaidAbilities\\SuppressorsSpawned.mp3")
	specWarnSuppressorFour:Schedule(200)
	soundSpecWarnSuppressor:Schedule(200, "Interface\\AddOns\\DBM-Core\\sounds\\RaidAbilities\\SuppressorsSpawned.mp3")
end
