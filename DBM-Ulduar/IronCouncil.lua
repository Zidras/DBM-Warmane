...
local timerOverloadCooldown		= mod:NewCDTimer(60, 63481, nil, nil, nil, 2, nil, DBM_CORE_DEADLY_ICON, nil, 1)
...
local timerOverwhelmingPower	= mod:NewTargetTimer(25, 61888, nil, nil, nil, 2, nil, DBM_CORE_MYTHIC_ICON, nil, 3)
...
local timerRuneofDeathDura		= mod:NewNextTimer(30, 63490, nil, nil, nil, 2, nil, DBM_CORE_DEADLY_ICON, nil, 1)
