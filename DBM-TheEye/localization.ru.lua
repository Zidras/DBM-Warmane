...
L:SetMiscLocalization{
	...
	YellPhase4	= "Увы, иногда приходится брать все в свои руки. Баламоре шаналь!",--Translate
	YellPhase5	= "Я не затем ступил на этот путь, чтобы остановиться на полдороги! Мои планы должны сбыться  и они сбудутся! Узрите же истинную мощь!",--Translate
	YellSang	= "Вы справились с моими лучшими советниками... Но перед мощью Кровавого Молота не устоит никто. Узрите лорда Сангвинара!",--Translate
	YellCaper	= "Каперниан проследит, чтобы вы не задержались здесь надолго.",--Translate
	YellTelo	= "Неплохо, теперь вы можете потягаться с моим главным инженером Телоникусом.",--Translate
	EmoteGaze	= "смотрит на ([^%s]+)!",--Translate
	...
	Bow			= "Длинный лук Края Пустоты",--Translate
	Axe			= "Сокрушение",--Translate
	Mace		= "Вселенский вдохновитель",--Translate
	Dagger		= "Клинки Бесконечности",--Translate
	Sword		= "Астральный тесак",--Translate
