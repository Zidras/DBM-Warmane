...
local timerNextStomp		= mod:NewNextTimer(20, 66330, nil, nil, nil, 2, nil, DBM_CORE_INTERRUPT_ICON, nil, mod:IsSpellCaster() and 3 or nil, 3)
...
local timerNextCrash		= mod:NewCDTimer(70, 66683, nil, nil, nil, 2, nil, DBM_CORE_MYTHIC_ICON) -- Original timer. The second Massive Crash should happen 70 seconds after the first
